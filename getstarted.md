...
<div class="gs-section-01" markdown="1">
  ...
  <h4>1. Fork this project</h4>

  <p><em>Click on the Fork button at the top right corner of this page. Forking means that you're copying this entire project and all its files into your account. Do not click on the Create fork button on the next page yet.</em></p>
</div>
